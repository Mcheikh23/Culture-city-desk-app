...
public class Seance {
    ...
    public Seance(int id_seance, Film film, Salle salle, Date date_seance) {
    ...
    public Seance(Film film, Salle salle, Date date_seance) {
        this.film = film;
        this.salle = salle;
        this.date_seance = date_seance;
    }
